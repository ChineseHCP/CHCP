...
sub_list=/md_disk3/guoyuan/CHCP_structure_function/SC_script/file_list/CHCP2.txt;
...
matrix_file=/md_disk3/guoyuan/CHCP_structure_function/SC/DTI/${data_num}/results/Network/Probabilistic/Customized_matrix_prob.csv;
...
for atlas in ${ATLAS_LIST[@]}; do
{
    ...
    ${RUN_DIR}/script/export_p_network_ygy_step2_multiple.py \
